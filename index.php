...
<?php get_template_part('David/Separateur', null, array('id' => 'separateur-1', 'title' => 'Separateur 1'));?>
<section id="Imp" class="Liens"></section>
<!-- <section class="Pixel PixelsO"></section> -->
<?php get_template_part('David/Separateur', null, array('id' => 'separateur-2', 'title' => 'Separateur 2'));?>
<section id="Imp" class="Profs"></section>
<!-- <section class="Pixel Pixelsv"></section> -->
<?php get_template_part('David/Separateur', null, array('id' => 'separateur-3', 'title' => 'Separateur 3'));?>
